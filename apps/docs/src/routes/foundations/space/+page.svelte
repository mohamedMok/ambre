<script lang="ts">
	...
	const space = byPrefix(tokens.system, 'space.');
	const radius = byPrefix(tokens.system, 'radius.');
	const control = byPrefix(tokens.system, 'size.control');
</script>

<svelte:head>
	<title>Space — Ambre</title>
